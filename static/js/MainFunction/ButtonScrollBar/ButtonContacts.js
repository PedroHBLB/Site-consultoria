const contacts_button = document.getElementsByClassName("main_contacts_button");

for (var i = 0; i < contacts_button.length; i++) {
  contacts_button[i].addEventListener("click", (e) => {
    let pai2 = e.target.parentNode.parentNode
    let pai3 = e.target.parentNode.parentNode.parentNode
    var button = e.target;
    var atributos = e.target.children[4].textContent.split(";");
    ...
    column_2_1.innerText = atributos[2];
    column_2_2.innerText = atributos[3];
    column_2_3.innerText = atributos[4];
    column_3_1.innerText = atributos[5];
    column_3_2.innerText = atributos[6];
    column_3_3.innerText = atributos[7];
  });
}
