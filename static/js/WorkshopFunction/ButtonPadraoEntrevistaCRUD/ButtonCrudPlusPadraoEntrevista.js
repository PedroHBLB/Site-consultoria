const button_plus = document.getElementsByClassName("plus_padraoentrevista")


for(var i =0;i<button_plus.length;i++){
    button_plus[i].addEventListener("click", (e) =>{
        ...
        let img = form.children[1].children[1].children[2].children[0]
        ...
        selectInput.value = "TEXTBOX"
        selectClasse.value = "Não Aplica"
        ...
        form.action = "/forms/CreateWorkshopPadraoEntrevista"
