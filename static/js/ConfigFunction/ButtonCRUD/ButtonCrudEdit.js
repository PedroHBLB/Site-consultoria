...
const crud_button = document.getElementsByClassName("crud_button")[1];
...
crud_button.addEventListener("click", (e) => {
  ...
  var button = pai2;
  var big_button = primal_button[parseInt(button.getAttribute("number")) - 1];
  ...
  if (number === "1") {
    form.action = "/forms/EditConfigVersion";
  } else if (number === "2") {
    form.action = "/forms/EditConfigOper";
  } else if (number === "3") {
    form.action = "/forms/EditConfigTask";
  }
});
